...
public class CutCtrl extends Controller {
    ...
    CutCtrl(File file) throws IOException {
...
//            System.out.println("Zaznaczono: " + data.startX + " , " + data.startY + " , " + data.endX + " , " + data.endY);
            ...
            startX = (int) (image.getWidth() * (double) startX / Dim.W(imgHolder.w));
            startY = (int) (image.getHeight() * (double) startY / Dim.H(imgHolder.h));
            endX = (int) (image.getWidth() * (double) endX / Dim.W(imgHolder.w));
            endY = (int) (image.getHeight() * (double) endY / Dim.H(imgHolder.h));
